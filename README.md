...
* `git clone git@github.com:rumblex/angularattack2016-goodfellas.git`

* `cd angularattack2016-goodfellas`
...
If you receive an error message `"You do not have permission to publish to goodfellas.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add kishorsharma7@gmail.com,manishkapoor1989@gmail.com,gargvicky2@gmail.com,rohit.kumar@tothenew.com`
